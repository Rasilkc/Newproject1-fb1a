[Newproject1-fb1a] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [Newproject1-fb1a] container is NOT running**.

.. tip::
   You must have your [Newproject1-fb1a] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42891  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rasilkc'  \-\-env DOCKERUSERNAME='rasilkc98'  \-\-env MQTTUSERNAME='Rasilkc'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   rasilkc98/Newproject1-fb1a-amd64 (https://hub.docker.com/r/rasilkc98/Newproject1-fb1a-amd64)
...
.. important::
   docker run -d -p 42877:42877 -p 49371:49371 -p 57367:57367 \-\-env TSS=0 \-\-env SOLUTIONNAME=Newproject1-fb1a \-\-env SOLUTIONDAG=solution_preprocessing_dag-Newproject1-fb1a \-\-env GITUSERNAME=Rasilkc  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi \-\-env SOLUTIONEXTERNALPORT=42877  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=49371  \-\-env SOLUTIONVIPERVIZPORT=57367 \-\-env DOCKERUSERNAME='rasilkc98'  \-\-env EXTERNALPORT=42891 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='Rasilkc' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rasilkc98/Newproject1-fb1a-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=57367
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=42877
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - rasilkc98/Newproject1-fb1a-amd64
...
It can be accessed by entering: http://localhost:49371
...
.. important::
   http://localhost:57367/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:57367/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:57367/<html file>
...
[Newproject1-fb1a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Rasilkc/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/Newproject1-fb1a
...
.. important::
   https://Newproject1-fb1a.readthedocs.io
...
.. important::
   solution_preprocessing_dag-Newproject1-fb1a
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=42877, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43903, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37627, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36837, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38951, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43287, HPDEHOST=127.0.1.1, HPDEPORT=39079, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46509

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5120-Newproject1-fb1a,solution_preprocessing_dag-Newproject1-fb1a, python-preprocess-2890-Newproject1-fb1a,solution_preprocessing_dag-Newproject1-fb1a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
